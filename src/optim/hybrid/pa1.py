...
from .common import FitnessFn, as_bounds, make_repair_row, init_population, eval_pop, best_of, gwo_step, woa_step
...
def optimize_pa1(
    ...
    *,
    ...
    """
    PA1: Sequential (GWO -> WOA)
    - GWO chạy nửa đầu (T1 iterations)
    - Chuyển TOÀN BỘ quần thể từ GWO sang WOA
    - WOA chạy nửa sau (T2 iterations) với quần thể từ GWO
