...
from src.optim.hybrid import optimize_pa1, optimize_pa2, optimize_pa3, optimize_pa4, optimize_pa5
    ...
    def optimize(
        ...
        *,
        ...
        if self.strategy not in _STRATEGY:
            raise ValueError(f"strategy phải thuộc {list(_STRATEGY.keys())}")
