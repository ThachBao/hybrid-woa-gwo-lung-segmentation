...
- **Độ chính xác**: Dice score trung bình > 0.85 trên tập test.
- **Thời gian xử lý**: Trung bình 2-5 phút cho một ảnh (tùy tham số).
- **So sánh thuật toán**: Hybrid WOA-GWO vượt trội hơn WOA và GWO đơn lẻ về tốc độ hội tụ và chất lượng phân đoạn.

**Ví dụ kết quả**:
- Ảnh gốc: X-quang ngực với vùng phổi mờ.
- Kết quả: Mask chính xác tách vùng phổi, overlay rõ ràng, metrics cao.
...
*Phiên bản: 1.0 | Cập nhật lần cuối: 28/04/2026*
- RAM: ≥ 4GB
- Hệ điều hành: Windows / Linux / macOS
- Không yêu cầu GPU
